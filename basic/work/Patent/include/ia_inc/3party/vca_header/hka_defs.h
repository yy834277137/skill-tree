...
* 作    者：武晓阳
* 日    期：2022年6月22日
* 备    注：1 修改HKA_SIZE_ALIGN出错bug（size为64位，align为U32时，会出错）
*
* 当前版本：1.0.1
* 作    者：申琳
* 日    期：2015年8月6日
...
#define HKA_MAX_U08     ( 0xFF )                        // 最大8位无符号整型值
#define HKA_MIN_U16     ( 0 )                           // 最小16位无符号整型值
#define HKA_MAX_U16     ( 0xFFFF )                      // 最大16位无符号整型值
#define HKA_MIN_U32     ( 0 )                           // 最小32位无符号整型值
#define HKA_MAX_U32     ( 0xFFFFFFFF )                  // 最大32位无符号整型值
...
* 对齐计算
***************************************************************************************************/
#define HKA_SIZE_ALIGN(size, align)  (((size) + (((typeof(size))align) - 1)) & (~(((typeof(size))align) - 1)))
