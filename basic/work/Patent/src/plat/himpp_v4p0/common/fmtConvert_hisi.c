...
{
    {SAL_VIDEO_DATFMT_YUV422SP_UV,  PIXEL_FORMAT_YUV_SEMIPLANAR_422},
    {SAL_VIDEO_DATFMT_YUV422SP_VU,  PIXEL_FORMAT_YVU_SEMIPLANAR_422},
    {SAL_VIDEO_DATFMT_YUV422P,      PIXEL_FORMAT_YVU_PLANAR_422},

    {SAL_VIDEO_DATFMT_YUV420SP_UV,  PIXEL_FORMAT_YUV_SEMIPLANAR_420},
    {SAL_VIDEO_DATFMT_YUV420SP_VU,  PIXEL_FORMAT_YVU_SEMIPLANAR_420},
    {SAL_VIDEO_DATFMT_YUV420P,      PIXEL_FORMAT_YVU_PLANAR_420},
};
 ...
 * @return
 */
INT32 fmtConvert_hisi_sal2hisi(SAL_VideoDataFormat enSalPixelFmt, PIXEL_FORMAT_E *penHiPixelFmt)
{
    UINT32 i = 0;
    UINT32 u32Num = 0;
 ...
 * @return
 */
INT32 fmtConvert_hisi_hisi2sal(PIXEL_FORMAT_E enHiPixelFmt, SAL_VideoDataFormat *penSalPixelFmt)
{
    UINT32 i = 0;
    UINT32 u32Num = 0;
