...
#define HD_COMMON_MEM_VB_INVALID_BLK           ((UINTPTR) -1)
#define HD_COMMON_MEM_SHARED_POOL_NUM           1
#define HD_COMMON_MEM_MAX_MMAP_NUM	            1024
typedef UINTPTR         HD_COMMON_MEM_VB_BLK;       ///< unsigned 64/32 bits data type
...
typedef struct _HD_COMMON_MEM_POOL_INFO {
	...
	UINTPTR                  start_addr;                                 ///< the starting address of this pool
...
typedef enum _HD_COMMON_MEM_DMA_DIR {
	HD_COMMON_MEM_DMA_BIDIRECTIONAL,             ///< it means flush operation.
	HD_COMMON_MEM_DMA_TO_DEVICE,                 ///< it means clean operation.
	HD_COMMON_MEM_DMA_FROM_DEVICE,               ///< it means invalidate operation.
	ENUM_DUMMY4WORD(HD_COMMON_MEM_DMA_DIR)
} HD_COMMON_MEM_DMA_DIR;
