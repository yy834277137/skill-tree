...
typedef enum _HD_VIDEOCAP_VI_SRC {
    ...
    HD_VIDEOCAP_VI_SRC_CSI0 = 64,                  ///< VI input source from CSI#0               (csi)
    HD_VIDEOCAP_VI_SRC_CSI1,                  ///< VI input source from CSI#1               (csi)
    HD_VIDEOCAP_VI_SRC_CSI2,                  ///< VI input source from CSI#2               (csi)
    HD_VIDEOCAP_VI_SRC_CSI3,                  ///< VI input source from CSI#3               (csi)
    HD_VIDEOCAP_VI_SRC_CSI4,                  ///< VI input source from CSI#4               (csi)
    HD_VIDEOCAP_VI_SRC_CSI5,                  ///< VI input source from CSI#5               (csi)
    HD_VIDEOCAP_VI_SRC_CSI6,                  ///< VI input source from CSI#6               (csi)
    HD_VIDEOCAP_VI_SRC_CSI7,                  ///< VI input source from CSI#7               (csi)
...
typedef enum _HD_VIDEOCAP_VI_FMT {
	...
	HD_VIDEOCAP_VI_FMT_BT656DH,               ///< BT656  DualHeader
	HD_VIDEOCAP_VI_FMT_CSI_16BIT,             ///< CSI 16bit
...
typedef enum _HD_VIDEOCAP_VI_CH_FMT {
	...
	HD_VIDEOCAP_VI_CH_FMT_CSI_16BIT,           ///< CSI 16bit
...
typedef enum _HD_VIDEOCAP_VI_CH_DATA_SRC{
    HD_VIDEOCAP_VI_CH_DATA_SRC_VI = 0,			///< data source from external video interface
    HD_VIDEOCAP_VI_CH_DATA_SRC_PATGEN,          ///< data source from internal pattern generator
    HD_VIDEOCAP_VI_CH_DATA_SRC_MAX
} HD_VIDEOCAP_VI_CH_DATA_SRC;

typedef enum _HD_VIDEOCAP_VI_CH_DATA_RANGE {
    HD_VIDEOCAP_VI_CH_DATA_RANGE_256 = 0,       ///< output data range 256 level
    HD_VIDEOCAP_VI_CH_DATA_RANGE_240,           ///< output data rnage 240 level
    HD_VIDEOCAP_VI_CH_DATA_RANGE_MAX
} HD_VIDEOCAP_VI_CH_DATA_RANGE;

typedef enum _HD_VIDEOCAP_VI_CH_SWAP{
    HD_VIDEOCAP_VI_CH_SWAP_NONE = 0,            ///< disable data swap
    HD_VIDEOCAP_VI_CH_SWAP_YC,                  ///< data YC swap
    HD_VIDEOCAP_VI_CH_SWAP_CbCr,                ///< data CbCr swap
    HD_VIDEOCAP_VI_CH_SWAP_YC_CbCr,             ///< data YC + CbCr swap
    HD_VIDEOCAP_VI_CH_SWAP_MAX
} HD_VIDEOCAP_VI_CH_SWAP;

typedef enum {
    HD_VIDEOCAP_VI_CH_CSI_VC_0 = 0,                        ///< data source from CSI virtual channel#0 when channel format is CSI_16BIT
    HD_VIDEOCAP_VI_CH_CSI_VC_1,                            ///< data source from CSI virtual channel#1 when channel format is CSI_16BIT
    HD_VIDEOCAP_VI_CH_CSI_VC_2,                            ///< data source from CSI virtual channel#2 when channel format is CSI_16BIT
    HD_VIDEOCAP_VI_CH_CSI_VC_3,                            ///< data source from CSI virtual channel#3 when channel format is CSI_16BIT
    HD_VIDEOCAP_VI_CH_CSI_VC_MAX
} HD_VIDEOCAP_VI_CH_CSI_VC;


typedef enum _HD_VIDEOCAP_VI_CH_PARAM_ID {
	HD_VIDEOCAP_VI_CH_PARAM_DATA_RANGE,         ///< channel output data range, parameter value as HD_VIDEOCAP_VI_CH_DATA_RANGE
	HD_VIDEOCAP_VI_CH_PARAM_YC_SWAP,            ///< channel output ycbcr swap, parameter value as HD_VIDEOCAP_VI_CH_SWAP
	...
	HD_VIDEOCAP_VI_CH_PARAM_CSI_VC,             ///< channel csi virtual channel selection, parameter value as HD_VIDEOCAP_VI_CH_CSI_VC
...
typedef enum _HD_VIDEOCAP_VI_VPORT_PARAM_ID {
	...
	HD_VIDEOCAP_VI_VPORT_PARAM_CLK_DELAY,       ///< vi vport pixel clock delay, parameter value as 0 ~ 0xff, the valid value depend on different platform
	HD_VIDEOCAP_VI_VPORT_PARAM_CLK_PDELAY,      ///< vi vport pixel clock polarity delay, parameter value as 0 ~ 0xff, support depend on different platform
...
typedef struct _HD_VIDEOCAP_HOST  {
	...
	struct {
		...
		UINT32 mb_x_num_max:12;     ///< specify horizontial motion block max number, 0 ~ 256, apply on buffer allocate from driver
		UINT32 mb_y_num_max:12;     ///< specify vertical motion block max number, 0 ~ 256, apply on buffer allocate from driver
...
typedef struct _HD_VIDEOCAP_VI_CH_NORM3 {
	UINT8 chip;               ///< chip index
	UINT8 vcap;               ///< vcap index
	UINT8 vi;                 ///< vi   index
	UINT8 ch;                 ///< ch   index
	...
	HD_VIDEOCAP_VI_CH_DATA_LATCH     data_latch;         ///< channel data latch mode
	HD_VIDEOCAP_VI_CH_HORIZ_DUP      horiz_dup;          ///< channel horizontal pixel duplicate mode
	HD_VIDEOCAP_VI_CH_DATA_SRC       data_src;           ///< channel data source type
	UINT32                           reserved[8];        ///< reserved
} HD_VIDEOCAP_VI_CH_NORM3;
...
typedef enum _HD_VIDEOCAP_DRV_PARAM_ID {
	...
	HD_VIDEOCAP_DRV_PARAM_VI_CH_NORM3,        ///<  support set/get video norm, using HD_VIDEOCAP_VI_CH_NORM3 struct
...
#define HD_VIDEOCAP_HDR_SENSOR3   2
#define HD_VIDEOCAP_HDR_SENSOR4   3
...
typedef enum _HD_VIDEOCAP_SEN_CLANE_SEL {
	...
	HD_VIDEOCAP_SEN_CLANE_SEL_CSI1_USE_C0,      ///< MIPI CSI1 uses HSI_CK0 as clock lane.
	...
	HD_VIDEOCAP_SEN_CLANE_SEL_CSI2_USE_C1,      ///< MIPI CSI2 uses HSI_CK1 as clock lane.
	HD_VIDEOCAP_SEN_CLANE_SEL_CSI2_USE_C2,      ///< MIPI CSI2 uses HSI_CK2 as clock lane.
	HD_VIDEOCAP_SEN_CLANE_SEL_CSI3_USE_C0,      ///< MIPI CSI3 uses HSI_CK0 as clock lane.
...
#define HD_VIDEOCAP_AD_MAP(ad_chip, ad_in, vdocap_id) (AD_CHIP(ad_chip)|AD_IN(ad_in)|(vdocap_id))

typedef enum _HD_VIDEOCAP_SEN_EXT_FUNC {
	HD_VIDEOCAP_SEN_HDR_MAP = 0,              ///< sensor HDR mapping, referring to HD_VIDEOCAP_SHDR_MAP
	HD_VIDEOCAP_SEN_AD_MAP,                   ///< analog Decoder mapping, e.g. HD_VIDEOCAP_AD_MAP(0, 0, HD_VIDEOCAP_0|HD_VIDEOCAP_1)
	HD_VIDEOCAP_SEN_MCLK_SRC_SYNC_SET,        ///< indicate which MCLKs of VCAP use the same clock source, bitwise setting for VIDEOCAPx, e.g. set 0x3 to sync VIDEOCAP0 and VIDEOCAP1
	HD_VIDEOCAP_SEN_MF_MAP,                   ///< multi-frame mapping, e.g. (HD_VIDEOCAP_0|HD_VIDEOCAP_1)
	ENUM_DUMMY4WORD(HD_VIDEOCAP_SEN_EXT_FUNC)
} HD_VIDEOCAP_SEN_EXT_FUNC;

typedef struct _HD_VIDEOCAP_SEN_CFG_EXT {
	UINT32    func;                             ///< extension function
	UINT32    value;                            ///< value
} HD_VIDEOCAP_SEN_CFG_EXT;

typedef struct _HD_VIDEOCAP_SEN_CONFIG_EXT {
	UINT32    cfg_num;                          ///< number of configuration
	HD_VIDEOCAP_SEN_CFG_EXT *p_sen_cfg_ext;     ///< pointer to the array of configuration
} HD_VIDEOCAP_SEN_CONFIG_EXT;

typedef struct _HD_VIDEOCAP_CONFIG3 {
	CHAR driver_name[HD_VIDEOCAP_SEN_NAME_LEN]; ///< sensor ko name
	HD_VIDEOCAP_SEN_CONFIG_EXT sen_cfg_ext;     ///< sensor extension config
} HD_VIDEOCAP_DRV_CONFIG3;
/********************************************************************
	TYPE DEFINITION
********************************************************************/
...
typedef enum _HD_VIDEOCAP_PARAM_ID{
	...
	HD_VIDEOCAP_PARAM_OUT_CROP,          ///< obsolete item, just the same with HD_VIDEOCAP_PARAM_IN_CROP
	...
	HD_VIDEOCAP_PARAM_DRV_CONFIG3,       ///< support set with ctrl path, using HD_VIDEOCAP_DRV_CONFIG3 struct
