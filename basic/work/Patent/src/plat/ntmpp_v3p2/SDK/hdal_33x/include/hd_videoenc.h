...
********************************************************************/
#define HD_VIDEOENC_MAX_IN         96   ///< max count of input of this device (interface)
#define HD_VIDEOENC_MAX_OUT        96   ///< max count of output of this device (interface)
...
typedef enum _HD_VIDEOENC_POOL_MODE {
	HD_VIDEOENC_POOL_AUTO    = 0,//not support
...
typedef struct _HD_H26XENC_USR_QP {
	...
	UINTPTR         qp_map_addr;        ///< buffer address of user qp map.
} HD_H26XENC_USR_QP;
...
typedef struct _HD_VIDEOENC_USER_BS_DATA {
	...
	UINTPTR user_buf_addr;              ///< user buffer address of encoded data
...
typedef struct _HD_VIDEOENC_VIDEO_PACK_NUM {
	UINT32      video_pack_num;              ///< number of video_pack required to alloc HD_VIDEOENC_BS3.video_pack
} HD_VIDEOENC_VIDEO_PACK_NUM;
...
typedef enum _HD_VIDEOENC_PARAM_ID {
	...
	HD_VIDEOENC_PARAM_OUT_TRIG_SNAPSHOT3, ///< support set with i/o path, using HD_H26XENC_TRIG_SNAPSHOT3 struct
	HD_VIDEOENC_PARAM_OUT_VIDEO_PACK_NUM, ///< support get with i/o path, using HD_VIDEOENC_VIDEO_PACK_NUM struct (for alloc HD_VIDEOENC_BS3.video_pack)
