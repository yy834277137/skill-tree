...
***********************************************************************************************************************/
//当前版本号
#define HKANN_SCHEDULER_MAJOR_VERSION        0     //主版本号
#define HKANN_SCHEDULER_SUB_VERSION          9     //副版本号
#define HKANN_SCHEDULER_REVISION_VERSION     5     //修订版本号
#define HKANN_SCHEDULER_ADDITION_VERSION     1     //补充版本号 

//版本日期
#define HKANN_SCHEDULER_VERSION_YEAR         2018  //年份
#define HKANN_SCHEDULER_VERSION_MONTH        09    //月份
#define HKANN_SCHEDULER_VERSION_DAY          03    //日期

//HKANN库最大管理设备数量
#define HKANN_SCHEDULER_MAX_DEV_NUM            10       //3559平台最大设备数量
...
//错误码
typedef enum _HKANN_SCHEDULER_ERR_CODE_E
{
    HKANN_SCHEDULER_ERR_RET_OK   = 0,
    HKANN_SCHEDULER_ERR_LACK_MEM = 0X86100000,
} HKANN_SCHEDULER_ERR_CODE_E;

//HKANN 调度器管理设备结构体
typedef struct _HKANN_SCHEDULER_MGR_PARAM_T
{
    HKANN_DEV_DATA_T  dev_data[HKANN_SCHEDULER_MAX_DEV_NUM];             // 设备数组
    int               dev_num;                                           // 设备数量
    int               priority;                                          // 进程优先级
