...
#ifndef _AUDIO_NTV3_H_
#define _AUDIO_NTV3_H_
 ...
 * @return      int  成功SAL_SOK，失败SAL_FAIL
 */
INT32 audio_ntv3_aiSetVolume(UINT32 u32Channel, UINT32 u32Volume);
 ...
 * @return      int  成功SAL_SOK，失败SAL_FAIL
 */
INT32 audio_ntv3_aoSetVolume(UINT32 u32Channel, UINT32 u32Volume);
