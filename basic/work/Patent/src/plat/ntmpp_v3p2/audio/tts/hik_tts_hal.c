...
INT32 hik_tts_start(void **ppHandle, UINT32 u32VoiceType)
{
    ...
    {
        strcpy(ltts_model_param.py_model_path, "/home/config/hik_tts/models/py_model.dat");
        strcpy(ltts_model_param.pp_vocab_path, "/home/config/hik_tts/models/vocab.txt");
        strcpy(ltts_model_param.pp_model_path, "/home/config/hik_tts/models/dd-albert-novocab-att-head-ts.bin");
        strcpy(ltts_model_param.melgan_model_path, "/home/config/hik_tts/models/hik_hifigan_female.model");
        strcpy(ltts_model_param.fs2_model_path, "/home/config/hik_tts/models/fs2_model_female.bin");
        strcpy(ltts_model_param.fs2_py2ph_path, "/home/config/hik_tts/models/fs2_py2ph_female.txt");
        strcpy(ltts_model_param.fs2_vocab_path, "/home/config/hik_tts/models/fs2_symbols_female.txt");
    }
    else
    {
        strcpy(ltts_model_param.py_model_path, "/home/config/hik_tts/models/py_model.dat");
        strcpy(ltts_model_param.pp_vocab_path, "/home/config/hik_tts/models/vocab.txt");
        strcpy(ltts_model_param.pp_model_path, "/home/config/hik_tts/models/dd-albert-novocab-att-head-ts.bin");
        strcpy(ltts_model_param.melgan_model_path, "/home/config/hik_tts/models/hik_hifigan_male.model");
        strcpy(ltts_model_param.fs2_model_path, "/home/config/hik_tts/models/fs2_model_male.bin");
        strcpy(ltts_model_param.fs2_py2ph_path, "/home/config/hik_tts/models/fs2_py2ph_male.txt");
        strcpy(ltts_model_param.fs2_vocab_path, "/home/config/hik_tts/models/fs2_symbols_male.txt");
    }
    ...
    pstTtsCtrl->stLttsMem.pinyin_mem_tab.base = SAL_memAlign(32, pstTtsCtrl->stLttsMem.pinyin_mem_tab.size, "audio", "tts");
    ...
    if ((NULL == pstTtsCtrl->stLttsMem.pp_mem_tab.base)
        || (NULL == pstTtsCtrl->stLttsMem.pinyin_mem_tab.base)
    ...
    pstTtsCtrl->stProcMem.pinyin_mem_tab.base = SAL_memAlign(32, pstTtsCtrl->stProcMem.pinyin_mem_tab.size, "audio", "tts");
    ...
    if ((NULL == pstTtsCtrl->stProcMem.pp_mem_tab.base)
        || (NULL == pstTtsCtrl->stProcMem.pinyin_mem_tab.base)
    ...
    *ppHandle = (void *)pstTtsCtrl;
    ...
    return SAL_SOK;
err1:
    if (pstTtsCtrl->stProcMem.pp_mem_tab.base)
    {
        SAL_memfree(pstTtsCtrl->stProcMem.pp_mem_tab.base, "audio", "tts");
    }
...
err2:
    if (pstTtsCtrl->stLttsMem.pp_mem_tab.base)
    {
        SAL_memfree(pstTtsCtrl->stLttsMem.pp_mem_tab.base, "audio", "tts");
    }
...
#if 0
    FILE *pFile = fopen("/home/config/tts_16k.pcm", "w+");
    if (pFile)
    {
