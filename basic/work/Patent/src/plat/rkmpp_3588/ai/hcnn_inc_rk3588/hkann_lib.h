...
#ifndef _HKANN_LIB_H__
#define _HKANN_LIB_H__
...
* 返回值：状态码
***********************************************************************************************************************/
int HKANN_GetModelMemSize(VCA_MODEL_INFO * params_info, VCA_MEM_TAB_V3 mem_tab[HKANN_MEM_TAB_NUM]);
...
* 返回值: 状态码
***************************************************************************************************/
int HKANN_CreateModel(VCA_MODEL_INFO   *params_info,
...
* 返回值: 返回状态码
***************************************************************************************************/
int HKANN_GetMemSize(HKANN_PARAM    *params_info,
                     VCA_MEM_TAB_V3  mem_tab[HKANN_MEM_TAB_NUM]);
...
* 返回值: 状态码
***************************************************************************************************/
int HKANN_Create(HKANN_PARAM     *params_info,
                 VCA_MEM_TAB_V3   mem_tab[HKANN_MEM_TAB_NUM],
                 void           **handle);
...
* 返回值：返回错误码
***************************************************************************************************/
int HKANN_SetConfig(void *handle,
                    int  cmd,
                    void *cfg,
                    int   cfg_size);
...
* 返回值：返回错误码
***************************************************************************************************/
int HKANN_GetConfig(void *handle,
                    int  cmd,
                    void *cfg,
                    int   cfg_size);
...
* 返回值: 返回错误码
***************************************************************************************************/
int HKANN_ReleaseModel(void *handle);
