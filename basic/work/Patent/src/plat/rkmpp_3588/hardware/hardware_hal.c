...
static INT32 HARDWARE_GetCpldInfo(VOID)
{
    ...
    if (ret < 0)
    {
        DISP_LOGI("get hardware failed: %s\n", strerror(errno));
        return SAL_FAIL;
    }
...
inline HARDWARE_INPUT_CHIP_E HARDWARE_GetInputChip(VOID)
{
    ...
    static const UINT32 au32AdvType[] = {DB_DS50018_V1_0, DB_DS50019_V1_0, DB_DS50018_V2_0, DB_RS20007_V1_0,
    ...
    static const UINT32 au32Lt9211McuMstarType[] = {DB_TS3719_V1_0, DB_RS20046_V1_0, DB_INVALID};
    ...
    static const BOARD_CAPT_CHIP_MAP_S astMap[] = {
        ...
        {HARDWARE_INPUT_CHIP_LT9211_MCU_MSTAR, au32Lt9211McuMstarType, },
    };
