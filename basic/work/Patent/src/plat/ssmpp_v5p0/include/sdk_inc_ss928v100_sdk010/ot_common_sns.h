...
#define BAYER_CALIBRATION_PARA_NUM_NEW 16
typedef struct {
    td_double calibration_coef[BAYER_CALIBRATION_PARA_NUM_NEW];
} ot_isp_cmos_noise_calibration;
...
typedef struct {
    ...
    ot_isp_cmos_noise_calibration     noise_calibration;
