 ...
 * @return	  INT32
 */
INT32 vdec_hiv5_VdecMakeframe(PIC_FRAME_PRM *pPicFramePrm, void *pstframe);
 ...
 * @return	  INT32
 */
INT32 vdec_hiv5_VdecCpyframe(VDEC_PIC_COPY_EN *copyEn, void *pstSrcframe, void *pstDstframe);
