...
#ifndef _ICF_INTERFACE_V2_H_
#define _ICF_INTERFACE_V2_H_
...
#define ICF_REVISION_VERSION         9

#define ICF_VERSION_YEAR             2022
#define ICF_VERSION_MONTH            6
#define ICF_VERSION_DAY              30
 ...
 *  @return   void
 */
typedef void (ICF_CALLBACK *ICF_DataCallBack_V2)(int           nNodeID,
                                                 int           nCallBackType,
                                                 void         *pstOutput,
                                                 unsigned int  nSize,
                                                 void         *pUsr,
...
/**  @fn       int (CALLBACK * ICF_SourceReleaseCB_V2)
  ...
  *  @return   int
  */
typedef int (ICF_CALLBACK *ICF_SourceReleaseCB_V2)(void        *pMemPool,
                                                   void        *pData,
                                                   int          nDataType);

/**  @fn       int (CALLBACK * ICF_MemAllocCB_V2)
  ...
  *  @return   int
  */
typedef int (ICF_CALLBACK *ICF_MemReleaseCB_V2)(void            *pInitHandle,
 ...
 *  @return   int
 */
typedef int (ICF_CALLBACK *ICF_MemAllocCB_V2)(void               *pInitHandle,
                                              const ICF_MEM_INFO_V2 *pMemInfo,
                                              ICF_MEM_BUFFER_V2     *stMemBuffer);

/** @fn       int (CALLBACK *ICF_DynamicRouterCB_V2)
 ...
 */
typedef int (ICF_CALLBACK *ICF_DynamicRouterCB_V2)(void *pInitHandle,
                                                   void *pNodeHandle,
                                                   void *pPackageHandle);
...
*  @return 回调状态码
*/
typedef int (ICF_CALLBACK *ICF_FuncAbnormalAlarm_V2)(void               *pInitHandle,
                                                     int                 nReturn,
