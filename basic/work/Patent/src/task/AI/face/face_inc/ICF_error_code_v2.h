...
#ifndef _ICF_ERROR_CODE_V2_H_
#define _ICF_ERROR_CODE_V2_H_
...
/* @reason: 是否找到引起的错误
// @brief:  找到(已经存在)计数器的内存指针/未找到计数器的内存指针/未找到线程ID/
*/
...
/* @reason: 大小相关的错误
// @brief:  系统快照工具记录的同一个关键字长度不一致/超出了系统快照工具记录数据的内存范围/
*/
#define ICF_TOOL_SIZE                             (0x88007009)
