...
#ifndef _ICF_TOOLKIT_V2_H_
#define _ICF_TOOLKIT_V2_H_
...
typedef struct _ICF_BLOCK_HEADER_V2
{
    ...
    int          nThreadID;
    char         sThreadName[NODE_NAME_LEN];
    unsigned int reserved[4];

}ICF_STR_ALIGN_4 ICF_BLOCK_HEADER_V2;
...
*   @return error code
*/
int ICF_EXPORT ICF_Snapshot_Status_V2(void *pExecuteHandle, int nKey, int nType, int nSize, void *pStatus);


/** @fn     ICF_Snapshot_GetMemInfo_V2
*   @brief  Get memory information of snapshot tool
*   @param  pInitHandle        [in]       - ICF init handle
*   @param  pMemBase           [out]      - the base of memory address
*   @param  pMemSize           [out]      - the size of memory
*   @return error code
*/
int ICF_EXPORT ICF_Snapshot_GetMemInfo_V2(void *pInitHandle, void **pMemBase, int *pMemSize);
