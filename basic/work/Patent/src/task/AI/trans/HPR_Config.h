...
//////////////////////////////////////////////////////////////////////////
    ...
    #pragma warning(disable: 4819) //unicodeÂ≠óÁ¨¶Ë≠¶Âëä
    ...
    #include <errno.h>
    #include <string.h>
    //#include <net/if.h> //ËøôËæπ‰∏çÂæó‰∏çÊ≥®Èáä,Âíåwireless.hÂÜ≤Á™Å‰∫Ü
...
//BAOQINGTI ADD
#define HPR_ETIMEOUT  -2        /* µ»¥˝≥¨ ± */
#define HPR_EINTR     -3        /* ±ª–≈∫≈÷–∂œ */
#define HPR_ERBUSY     -4        /* ∂‘œÛ√¶ */
